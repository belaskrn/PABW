...
<!-- 
    ...
    <div class="col-sm-7 mb-3 mb-sm-0">
            <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
              <button type="button" class="btn btn-primary"><img src="\img\p.png" class="rounded-circle" width="150">Nama yang punya akun</button>
              <button type="button" class="btn btn-primary">TicketInPay</button>
              <button type="button" class="btn btn-primary">Pesanan</button>
              <button type="button" class="btn btn-primary">Riwayat Pemesanan</button>
              <button type="button" class="btn btn-primary">Keluar Akun</button>
            </div>
            ...
            <div class="container text-center">
              <div class="row row-cols-1">
                 <div class="col"><img src="\img\p.png" class="rounded-circle" width="150">Fauzan Maftuh Alwafi</div>
                  <div class="col"><ion-icon name="wallet-outline" size="small"></ion-icon>  TicketInPay</div>
                  <div class="col"><ion-icon name="reader-outline" size="small"></ion-icon>  Pesanan</div>
                  <div class="col"><ion-icon name="receipt-outline" size="small"></ion-icon>  Riwayat Pemesanan</div>
                  <div class="col"><ion-icon name="log-out-outline" size="small"></ion-icon>  Keluar Akun</div>
              </div>
            </div>
          </div>
          <div class="col-7">
