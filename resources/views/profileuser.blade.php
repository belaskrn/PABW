          ...
          <div class="col-4">
            <div class="container text-center">
              <div class="row row-cols-1">
                 <div class="col"><img src="\img\p.png" class="rounded-circle" width="150">Nama yang punya akun</div>
                  <div class="col"><img src="..." class="img-thumbnail" alt="">TicketInPay</div>
                  <div class="col">Pesanan</div>
                  <div class="col">Riwayat Pemesanan</div>
                  <div class="col">Keluar Akun</div>
              </div>
            </div>
          </div>
          <div class="col-7">
